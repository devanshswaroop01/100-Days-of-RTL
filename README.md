...
Hi 👋, I'm **Devansh Swaroop**. I’m diving deep into the world of **VLSI**, focusing on **RTL design using Verilog HDL**. My goal is to master **Register Transfer Level (RTL) design in 100 days** and build a strong foundation in **digital design for FPGAs and ASICs**.
...
| 024 | N-bit Number Square [N²]              | Combinational arithmetic         |
...
| 033 | Vedic Multiplier (2×2)                | Fast multiplication method       |
...
* Stepwise progression from combinational logic → sequential logic → FSM → memory → arithmetic → interfaces.
